...
export const translation: SiteTranslation = {
  home: {
    ...
    pricing: { secure: 'Pagamento seguro com cartão', activates: 'A subscrição fica ativa na app logo após o pagamento', questions: 'Dúvidas? Escreva-nos' },
  ...
  subscription: {
    ...
    checkout: {
      ...
      redirecting: 'A redirecionar para a página de pagamento…',
    ...
    terms: {
      ...
      privacy: ['Tratamos os dados da conta e da encomenda para executar o contrato — consulte a ', 'política de dados pessoais', '. Os dados do cartão são introduzidos apenas na página do serviço de pagamentos.'],
