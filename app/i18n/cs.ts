...
export const translation: SiteTranslation = {
  home: {
    ...
    pricing: { secure: 'Bezpečná platba kartou', activates: 'Předplatné se v aplikaci zapne hned po zaplacení', questions: 'Máš otázky? Napiš nám' },
  ...
  subscription: {
    ...
    checkout: {
      ...
      redirecting: 'Přesměrováváme tě na platební stránku…',
    ...
    terms: {
      ...
      privacy: ['Údaje o účtu a objednávce zpracováváme za účelem plnění smlouvy — viz ', 'zásady zpracování osobních údajů', '. Údaje o kartě zadáváš pouze na stránce platební služby.'],
