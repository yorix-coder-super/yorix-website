...
export const translation: SiteTranslation = {
  home: {
    ...
    pricing: { secure: 'Sichere Kartenzahlung', activates: 'Das Abo ist direkt nach der Zahlung in der App aktiv', questions: 'Fragen? Schreib uns' },
  ...
  subscription: {
    ...
    terms: {
      ...
      privacy: ['Konto- und Bestelldaten verarbeiten wir zur Erfüllung des Vertrags – mehr dazu in der ', 'Datenschutzrichtlinie', '. Kartendaten gibst du nur auf der Seite des Zahlungsdienstes ein.'],
