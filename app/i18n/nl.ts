...
export const translation: SiteTranslation = {
  home: {
    ...
    pricing: { secure: 'Veilig betalen met je kaart', activates: 'Het abonnement staat direct na betaling aan in de app', questions: 'Vragen? Neem contact op' },
  ...
  subscription: {
    ...
    checkout: {
      ...
      redirecting: 'Je gaat naar de betaalpagina…',
    ...
    terms: {
      ...
      privacy: ['We verwerken account- en bestelgegevens om de overeenkomst uit te voeren – zie het ', 'beleid voor persoonsgegevens', '. Kaartgegevens voer je alleen in op de pagina van de betaaldienst.'],
