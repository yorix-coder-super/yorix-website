...
// The Russian audience reads these guides most, so its generic article is
// written in Russian end to end; other locales still carry the English body
// under a translated title until they are translated.
function makeSharedRu(): ReturnType<typeof makeShared> {
