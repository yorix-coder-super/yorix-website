...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/gift', languages: { en: '/gift', ru: '/ru/gift', 'x-default': '/gift' } },
  openGraph: { title: text.redeemTitle, description: text.entryBody, url: '/gift', type: 'website', images: ['/art/gift-card.webp'] },
};

export default function Page() {
  return <GiftEntryPage lang="en" />;
}
