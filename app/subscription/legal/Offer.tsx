  ...
  return [
    ...
    },
    {
      ...
      blocks: [
        ...
        '5.7. **Подписка в подарок.** Пользователь может оплатить Подписку на 30 или 365 суток для другого лица. После оплаты ссылка, код и открытка с кодом показываются Пользователю на странице результата оплаты и остаются доступны на странице подарка после входа через Apple; передать их получателю — забота Пользователя. По электронной почте Исполнитель их не направляет.',
  ...
  return [
    ...
    },
    {
      ...
      blocks: [
        ...
        '5.7. **Gift subscriptions.** The User may pay for a 30- or 365-day Subscription for someone else. After payment the gift link, the code and a printable card with the code are shown to the User on the payment result page and stay available on the gift page after signing in with Apple; passing them to the recipient is up to the User. The Provider does not send them by e-mail.',
