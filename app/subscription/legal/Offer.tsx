  ...
  return [
    ...
    },
    {
      ...
      blocks: [
        ...
        '4.5. Оплату подтверждает электронный чек Платёжного сервиса. Чек, сформированный Исполнителем в приложении «Налог на профессиональный доход», предоставляется Пользователю в электронном виде в срок, установленный налоговым законодательством. По требованию Пользователя Исполнитель выдаёт документ с указанием своих фамилии, имени, отчества, наименования и цены услуги.',
  ...
  return [
    ...
    },
    {
      ...
      blocks: [
        ...
        '4.5. Payment is confirmed by the Payment Service’s electronic receipt. The receipt the Provider issues in the “Professional income tax” app is provided to the User electronically within the time set by tax law. On request the Provider issues a document stating his full name and the name and price of the service.',
